...
#for ligand element N and O to protein N and O
...
found_no_hbonds = []
with open("hbonds_statistic_PDB_NO_to_NO.csv","w") as f:
  ...
  for pdb in pdb_file_list:
    if pdb: #如果不是空值的话
      ...
      resi_atom, lig_atom, distances = list_hb(selection, selection2, cutoff=3.2,angle=55,mode=1,hb_list_name='hbonds') #这里的角度就相当于125度
